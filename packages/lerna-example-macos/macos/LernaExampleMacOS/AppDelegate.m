...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"LernaExampleMacOS"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit LernaExampleMacOS" action:@selector(terminate:) keyEquivalent:@"q"];
